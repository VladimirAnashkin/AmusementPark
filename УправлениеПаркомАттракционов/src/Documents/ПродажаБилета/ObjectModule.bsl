...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	Для Каждого СтрокаТаблицы из СвойстваНоменклатуры Цикл
		// регистр ПосещенияАттракционов
		Движение = Движения.ПосещенияАттракционов.Добавить();
		Движение.Период = Дата;
		Движение.ВидДвижения = ВидДвиженияНакопления.Приход;
		Движение.Основание = Ссылка;
		Движение.ВидАттракциона = СтрокаТаблицы.ВидАттракциона;
		Движение.КоличествоПосещений = СтрокаТаблицы.КоличествоПосещений;
...
Функция СвойстваНоменклатуры()
	...
	СвойстваНоменклатуры = Запрос.Выполнить().Выгрузить();
